...
Apart from fixing bugs within the code that cause servers/clients to crash or gameplay to be messed up in some way, I will not be spending more time on tagpro-clone. However, I still feel tagpro-clone is incomplete. Below are some major features that are found in Tagpro but are missing from tagpro-clone.
