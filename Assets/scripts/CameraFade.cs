...
{   
	...
	{   
		...
		{			
			...
			if (Mathf.Abs(m_CurrentScreenOverlayColor.a - m_TargetScreenOverlayColor.a) < Mathf.Abs(m_DeltaColor.a) * Time.unscaledDeltaTime)
			{
			...
			{
				// fade!
				SetScreenOverlayColor(m_CurrentScreenOverlayColor + m_DeltaColor * Time.unscaledDeltaTime);
			}
		}
